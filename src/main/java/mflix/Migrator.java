...
public class Migrator {
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://m220student:m220password@mflix.xdpbu.mongodb.net";
        ...
        // format pattern
        Bson queryFilter = Filters.not(Filters.type("lastupdated", "date"));
        dateStringFilter = queryFilter;
